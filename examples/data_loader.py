...
class QADataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        guid, query, passage, negative_raw_logits, positive_raw_logits, negative_softmax_logits, positive_softmax_logits = self.data.all_pairs[i]
        ...
        label = map_to_torch_float([float(la) for la in [positive_raw_logits]])
