...
from transformers import (WEIGHTS_NAME, BertConfig,
                                  ...
                                  RobertaForSequencePairwiseClassification,
                                  RobertaTokenizer,
...
MODEL_CLASSES = {
    ...
    'roberta': (RobertaConfig, RobertaForSequencePairwiseClassification, RobertaTokenizer),
...
def main():
    ...
    parser.add_argument("--previous_model_dir", default=None, type=str, 
                        help="The input directory where the model saved.")
