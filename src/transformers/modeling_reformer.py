...
class ReformerModel(ReformerPreTrainedModel):
    ...
    def _pad_to_mult_of_chunk_length(
        ...
        if input_ids is not None:
            ...
            token_type_ids = torch.cat([token_type_ids, padded_input_ids], dim=-1)
            input_shape = input_ids.size()
...
@add_start_docstrings(
    """Reformer Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
class ReformerForQuestionAnswering(ReformerPreTrainedModel):
    ...
    Examples::
        ...
        outputs = (start_logits, end_logits,) + reformer_outputs[2:]
