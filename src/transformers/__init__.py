...
_import_structure = {
    ...
    "models.tulrv5": ["TULRv5_PRETRAINED_CONFIG_ARCHIVE_MAP", "TULRv5Config", "TULRv5Tokenizer"],
...
if TYPE_CHECKING:
    ...
    from .models.tulrv5 import TULRv5_PRETRAINED_CONFIG_ARCHIVE_MAP, TULRv5Config, TULRv5Tokenizer
